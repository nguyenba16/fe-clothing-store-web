...
const sampleReviews = [
    {
        ...
        rating: 5,
        date: '12/03/2025',
        comment: 'Sản phẩm chất lượng tuyệt vời, vải mềm và thoáng mát. Đúng như mô tả và giao hàng nhanh.',
        helpful: 12
    },
    {
        id: 2,
        ...
        rating: 2,
        date: '05/03/2025',
        comment: 'Tôi rất hài lòng với chất lượng sản phẩm. Tuy nhiên kích thước hơi rộng một chút so với bảng size.',
        helpful: 8
    },
    {
        id: 3,
    ...
    return (
        <div>
            <div className="max-w-7xl mx-auto p-4 md:p-6 flex flex-col md:flex-row gap-8 font-text">
                ...
                <div className="w-full md:w-1/2 flex flex-col-reverse md:flex-row gap-5">
                    ...
                    <div className="flex flex-row md:flex-col justify-center gap-3">
                        {productImages.map((image, index) => (
                            <div
                                key={index}
                                className={`w-20 h-20 border cursor-pointer overflow-hidden transition-all duration-200 ${selectedImage === index ? 'border-purple-600 border-2' : 'border-gray-200 opacity-30'
                                    }`}
                ...
                <div className="w-full md:w-1/2 flex flex-col gap-6 p-2 md:p-10 border rounded-lg">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <div>
                            ...
                            <div className="flex gap-3">
                                {colors.map((color, index) => (
                                    <div
                                        key={index}
                                        className={`w-7 h-7 rounded border cursor-pointer transition-all duration-200 ${selectedColor === index ? 'border-pink-300 border-2 scale-105' : 'border-gray-200'
                                            }`}
                        ...
                        <div>
                            ...
                            <div className="mt-3 text-sm">
                                <a href="#" className="text-purple-700 hover:underline">Find your size</a> | <a href="#" className="text-purple-700 hover:underline">Measurement guide</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-4 mt-4">
                        <button className="w-24 h-12 border border-gray-200 rounded-3xl bg-white flex items-center justify-center transition-all duration-200 hover:border-purple-600 hover:bg-purple-50" onClick={handleAddToCart}>
                            <img src={addcart} alt="Add to Cart" className="w-6 h-6" />
                        </button>
                        <button className="flex-1 h-12 border rounded-3xl text-pink font-semibold text-sm tracking-wide transition-all duration-200 hover:bg-pink-600 hover:text-white" onClick={handleBuyNow}>
                            MUA NGAY
                        </button>
                    </div>
                </div>
            ...
            <div className='max-w-7xl mx-auto p-4 md:p-6 flex flex-col gap-8 font-text'>
                <div className='text-xl md:text-2xl font-bold uppercase tracking-wide underline text-third'>MÔ TẢ SẢN PHẨM</div>
                <div>{description}</div>
            </div>

            {/* Đánh giá của người mua */}
            <div className='max-w-7xl mx-auto p-4 md:p-6 flex flex-col gap-8 font-text'>
                <div className='text-xl md:text-2xl font-bold uppercase tracking-wide underline text-third'>ĐÁNH GIÁ CỦA NGƯỜI MUA</div>
                    ...
                    {showReviewForm && (
                        <div className='w-full md:w-2/3 bg-white p-6 border rounded-lg'>
                            ...
                            <form onSubmit={handleSubmitReview}>
                                ...
                                <div className='mb-4'>
                                    <label htmlFor='reviewComment' className='block mb-2'>Nội dung đánh giá</label>
                                    <textarea
                                        id='reviewComment'
                                        value={reviewComment}
