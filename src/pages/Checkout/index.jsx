                    ...
                    <div className="bg-white rounded-lg shadow-md p-6 sticky top-8">
                        ...
                        <div className="border-t border-gray-200 pt-4">
                            <div className="flex justify-between mb-2">
                                <span>Tạm tính</span>
                                <span>{new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(calcSubtotal())}</span>
                            </div>
                            ...
                            <div className="flex justify-between mb-2">
                                ...
                                <span>
                                    {calcShippingFee() > 0
                                        ? new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(calcShippingFee())
                                        : 'Miễn phí'}
                                </span>
                            </div>
                            ...
                            <div className="border-t border-gray-200 pt-4 mt-2">
                                <div className="flex justify-between font-bold text-lg">
                                    <span>Tổng cộng</span>
                                    <span>{new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(calcTotal())}</span>
                                </div>
                            </div>
                        </div>
